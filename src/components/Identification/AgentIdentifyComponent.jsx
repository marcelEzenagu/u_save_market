...
import AgentVerification from "./Verifications/AgentVerification";
import { useVerifyAgentMutation } from "../../features/admin/adminApiSlice";

function AgentIdentifyComponent({scheduleInterview, handleSet,data}) {
...
export default AgentIdentifyComponent;
