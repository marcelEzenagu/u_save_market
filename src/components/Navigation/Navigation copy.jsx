...
//             </div>
//             <CartDropdown />
//             <SearchFormMobile preferredCountry={preferredCountry}  showMessage={showMessage}  searchItems={searchItems}/>
//           </div>
//         </div>
...
// const SearchForm = React.memo(({preferredCountry,searchItems,query,handleChange}) => {
//   const dropdownRef = useRef(null);
...
// const SearchFormMobile = React.memo(({preferredCountry, showMessage,searchItems }) => {
