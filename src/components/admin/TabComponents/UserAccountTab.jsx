          ...
          <div className="flex flex-col items-start gap-4 ">
            ...
            <div className="flex flex-row items-center gap-2">
              <div className="flex items-center gap-1">
                ...
                <span className="text-sm text-regal-warning font-[600]">
                  Pending
                </span>
              </div>
              ...
              <div className="flex items-center gap-1">
                ...
                <u className="text-sm text-regal-sky-blue  font-[600] ">
                  Schedule Meeting
                </u>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8 mb-4">
            {data?.businessName &&
              <div className="mb-1 col-span-2">
                ...
                <div className="w-full p-3 md:p-4 text-xs md:text-[12px] border font-[300] focus:outline-regal-blue rounded-lg bg-transparent text-regal-black">
            ...
            <div className="mb-1 col-span-2">
              ...
              <div className="relative">
                ...
                <button 
                  disabled
                  className="absolute top-4 right-4 text-regal-black text-xl">
                  <PiCopy />
                </button>
              </div>
            </div>
          </div>
          <button className="inline-block px-8  py-2 md:py-3 mt-8  text-[10px] md:text-xs text-white border-regal-sky-blue bg-regal-sky-blue rounded-sm cursor-pointer">
            Update Details
          </button>
        </section>
      </div>
