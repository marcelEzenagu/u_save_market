...
import { useAdminListAgentShipmentQuery } from "../../../features/admin/adminApiSlice";

function AgentShipmentTab({data:userData}) {
  const [dropdownOption, setDropdownOption] = useState("This Month");
  const [isOpenSelect, setIsOpenSelect] = useState(false);
  const [activeOrder, setActiveOrder] = useState(null);

  const {data:shipments,isLoading}=useAdminListAgentShipmentQuery({agentID:userData.agentID})
...
export default AgentShipmentTab;
