  ...
  const Links = [
    {
      ...
      image: (
        ...
        >
          ...
          />
          <path
            d="M17.08 14.1499C14.29 12.2899 9.74002 12.2899 6.93002 14.1499C5.66002 14.9999 4.96002 16.1499 4.96002 17.3799C4.96002 18.6099 5.66002 19.7499 6.92002 20.5899C8.32002 21.5299 10.16 21.9999 12 21.9999C13.84 21.9999 15.68 21.5299 17.08 20.5899C18.34 19.7399 19.04 18.5999 19.04 17.3599C19.03 16.1299 18.34 14.9899 17.08 14.1499Z"
            fill="#262729"
          />
        </svg>
      ),
    ...
    <div className="">
      <div className="py-2 flex flex-row md:flex-col overflow-x-scroll md:min-h-[600px]  md:w-44 md:pr-9 md:border-r shadow-md md:shadow-none">
        {Links?.map((e, i) => (
          <div
            key={e.url}
            className={`my-1 mx-2 md:mx-0 hover:bg-gray-100 ${
              active === e.id && "bg-gray-100 px-3"
            } hover:px-3 w-auto rounded-md`}
          >
            <Link
              to={e.url}
              className="text-regal-black text-xs md:text-sm flex flex-row whitespace-nowrap items-center font-[500] py-1 md:py-2  transition rounded-md "
            >
              {" "}
              <span className="mr-2 ">{e.image}</span> {e.name}
            </Link>
          </div>
        ))}
      </div>
