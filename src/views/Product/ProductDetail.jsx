      ...
      {productInfo ? (
        <main className="my-4 mb-20 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="w-full h-80 relative">
            <img
              src={
                productInfo?.images ? `${productInfo?.images}` : ReplaceImage
              }
            ...
            <h5 className="text-lg font-[700] flex items-center gap-2 text-regal-blue">
              ...
              {numberWithCommas(
                (
                  (productInfo?.newPrice
                    ? productInfo?.newPrice
                    : productInfo?.salesPrice) * exchangeRate?.rate
                ).toFixed(2)
              )}{" "}
              {productInfo?.percentageOFF !== null ? (
                <s className="font-[400] text-xs text-regal-light-gray ">
                  ...
                  {numberWithCommas(
                    (
                      (productInfo?.newPrice ? productInfo?.salesPrice : 0) *
                      exchangeRate?.rate
                    ).toFixed(2)
                  )}
                </s>
        ...
        <div id="notfound">
          <div className="notfound">
            ...
            <p className="text-gray-600 text-center mb-4">
              ...
              <span className="font-bold">{name}</span>" is either out of stock
