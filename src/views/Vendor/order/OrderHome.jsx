...
<div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 md:gap-4 md:px-4 relative border rounded-md bg-white mt-8">
  {[
    { name: 'Total Orders', icon: <FaShoppingCart />, total: 183, percentage: '+12%' },
    { name: 'Processing Orders', icon: <FaUserPlus />, total: 96, percentage: '+5%' },
    { name: 'Shipped Orders', icon: <LiaBoxSolid />, total: 12, percentage: '+3%' },
    { name: 'Delivered Orders', icon: <LiaBoxSolid />, total: 25, percentage: '+3%' },
    { name: 'Return Orders', icon: <LiaBoxSolid />, total: 25, percentage: '+3%' },
  ].map((item) => (
