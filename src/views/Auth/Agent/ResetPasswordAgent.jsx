...
import { useResetPasswordAgentMutation } from "../../../features/auth/authApiSlice";
...
const ResetPasswordAgent = () => {
  ...
  const [ResetPasswordAgent, { isLoading }] = useResetPasswordAgentMutation();
