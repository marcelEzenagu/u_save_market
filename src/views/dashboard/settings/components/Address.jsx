...
import NoAddressicon from "../../../../assets/images/settings/noaddress.png";
...
function Address() {
  ...
  return (
    <div className="p-4">
      ...
      <EditAddress
        isModalOpen={isModalOpenEditAddress}
        setIsModalOpen={(e) => {
          setIsModalOpenEditAddress(e);
        }}
      />
      <AddAddress
      ...
      />
      <DeleteAddress
        isModalOpen={isModalOpenDeleteAddress}
        setIsModalOpen={(e) => {
          setIsModalOpenDeleteAddress(e);
        }}
      />
    </div>
  );
