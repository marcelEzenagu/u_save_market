...
function PaymentOverview() {
  ...
  return (
    ...
    <div className="bg-white p-4 md:p-6">
        <div className="flex flex-row items-center justify-between">
          <h5 className="text-regal-black text-xs md:text-2xl font-[700] flex flex-row items-center gap-2">
            <span className='text-regal-crum-gray'>Payments</span> <IoIosArrowForward className='text-regal-crum-gray'/> <span>ID: 099084057</span> <GetStatus/>
          </h5>
        </div>
      </div>
    </main>
    ...
    <section className='bg-white m-4 rounded-lg md:col-span-3'>
      <main className='p-4 pb-8 mt-4 flex flex-row items-start justify-between  border-b'>
      <div className="flex flex-col md:flex-row items-start justify-between">
          <div>
            <p className="text-sm md:text-lg text-start flex gap-2 text-regal-black font-bold">
              ID: 9692893
            </p>
            <p className="text-xs md:text-sm text-regal-light-gray text-start mt-1">
            Destination: <span className="font-bold">Kabul, Afghanistan</span> 
            </p>
            <p className="text-xs md:text-sm text-regal-light-gray text-start mt-1">
            Est. Delivery Time: <span className="font-bold">7 days</span> 
            </p>
            <p className="text-xs md:text-sm text-regal-light-gray text-start mt-1">
            No of Items:  <span className="font-bold">12 Items</span> 
            </p>
            <p className="text-xs md:text-sm text-regal-light-gray text-start mt-1">
            Date of Loading:  <span className="font-bold">2nd Aug, 2023</span> 
            </p>
          </div>

        </div>

            <h2 className="text-xs md:text-sm font-bold text-regal-sky-blue">Withdrawal: ₦1,585.00</h2>
      </main>

        <main className="max-w-[600px] p-2 md:p-4">
        <div className="mb-4">
